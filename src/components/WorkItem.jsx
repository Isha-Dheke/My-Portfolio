    ...
    <ol className='flex flex-col md:flex-row relative border-l border-stone-200'>
      <li className='mb-10 ml-4 '>
        ...
        <p className='flex flex-wrap gap-4 justify-start items-center text-xs md:text-sm'>
          <span className='inline-block px-2 py-1 text-white bg-blue-950 font-semibold rounded-md'>{year}</span>
          <span className='text-lg font-semibold  text-blue-950'>{title}</span>
