       ...
       ''
        ...
        <div className="md:block hidden fixed top-[25%] z-10">
            <div className="flex flex-col  " >
                ...
                <a href="#contact onClick={handleNav}" className="rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-200">
                    <AiOutlineMail size={20}/>
                </a>
            </div>
        </div>
